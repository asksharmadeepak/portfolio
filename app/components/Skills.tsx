...
const skills = [
  {
    ...
    tech: "Java, Scala, Kotlin",
    description: "Building robust backend systems with modern JVM languages and frameworks.",
    color: "text-blue-500",
  },
  {
    icon: Server,
  ...
  },
  {
    ...
    tech: "Hibernate, JPA",
    description: "Managing data with ORM frameworks and implementing efficient database solutions.",
  ...
  },
  {
    ...
    description: "Creating responsive and modern user interfaces with Angular and web technologies.",
    color: "text-pink-500",
  },
  {
    icon: GitBranch,
    name: "Version Control & CI/CD",
    tech: "Git, DevOps practices",
  ...
  },
  {
    ...
    tech: "TDD, ATDD",
    description: "Implementing test-driven development and acceptance test-driven development.",
    color: "text-yellow-500",
  },
  {
    icon: Layers,
    name: "Architecture",
    tech: "System Design, Patterns",
    description: "Designing scalable system architectures and implementing design patterns.",
